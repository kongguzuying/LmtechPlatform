...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            <form class="form-inline" action="${pageContext.request.contextPath}/platform/cardActiveRecord/list.do" role="form"
                  method="post">
                <div class="adv-table">
                    <div class="row-fluid">
                        <div class="span3">
                                ...
                                <td>${item.errMsg}</td>
                                    ...
                                    <%--<td>
                                        <div class="btn-group">
                                            ...
                                            <a href="javascript:listRemove('${pageContext.request.contextPath}/platform/cardActiveRecord/remove.do?id=${item.id}')"
