...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            <form class="form-inline" action="${pageContext.request.contextPath}/platform/rechargePayRecord/list.do" role="form"
                  method="post">
                <div class="adv-table">
                    <div class="row-fluid">
                        <div class="span3">
                                ...
                                <td>${item.status}</td>
                                    ...
                                    <%--<td>
                                        <div class="btn-group">
                                            ...
                                            <a href="javascript:listRemove('${pageContext.request.contextPath}/platform/rechargePayRecord/remove.do?id=${item.id}')"
