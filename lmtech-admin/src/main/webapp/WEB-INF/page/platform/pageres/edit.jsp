...
<div class="col-xs-12">
    <div class="form">
        <form class="cmxform form-horizontal" method="post" action="${pageContext.request.contextPath}/pageres/edit.do" novalidate="novalidate">
            <div class="form-group ">
                <label for="name" class="control-label col-xs-2">资源编号<span class="required">*</span></label>
                <div class="col-xs-8">
                    <input class=" form-control" id="id" name="id" value="${entity.id}" <c:if test="${!empty entity.id}">readonly="readonly"</c:if> type="text">
                </div>
            </div>
            <div class="form-group ">
            ...
            <div class="form-group ">
                <label for="name" class="control-label col-xs-2">模块代码</label>
                <div class="col-xs-8">
                    <input class=" form-control" id="moduleCode" name="moduleCode" value="${entity.moduleCode}" type="text">
                </div>
            </div>
            <div class="form-group ">
                <label for="name" class="control-label col-xs-2">模块名称</label>
                <div class="col-xs-8">
                    <input class=" form-control" id="moduleName" name="moduleName" value="${entity.moduleName}" type="text">
                </div>
            </div>
            <div class="form-group ">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-offset-2 col-xs-3">
                    ...
                    <a class="btn btn-default" href="${pageContext.request.contextPath}/pageres/list.do">返回</a>
                </div>
            </div>
        </form>
    </div>
